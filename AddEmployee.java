...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee()
    {
        ...
        name.setFont(new Font("Tahama",Font.PLAIN,17));
        ...
        age.setFont(new Font("Tahama",Font.PLAIN,17));
        ...
        gender.setFont(new Font("Tahama",Font.PLAIN,17));
        ...
        r2.setFont(new Font("Tahama",Font.PLAIN,13));
        ...
        job.setFont(new Font("Tahama",Font.PLAIN,17));
        job.setBounds(60,180,120,30);
        add(job);
        
        String str[]={"Front Desk Clerks","Forters","Housekeeping","Kitchen Staff","Room Service","Waiter/Waitress","Manager","Accountant","Chef"};
        ...
        salary.setFont(new Font("Tahama",Font.PLAIN,17));
        ...
        phone.setFont(new Font("Tahama",Font.PLAIN,17));
        ...
        aadhar.setFont(new Font("Tahama",Font.PLAIN,17));
        ...
        email.setFont(new Font("Tahama",Font.PLAIN,17));
        ...
        l2.setBounds(420,-180,450,450);
        l2.setFont(new Font("Tohoma",Font.PLAIN,25));
        add(l2);
        
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        setBounds(220,130,850,520);
        setVisible(true);
